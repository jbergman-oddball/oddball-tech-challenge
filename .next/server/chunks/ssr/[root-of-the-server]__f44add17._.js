...
"[project]/src/lib/data:bc4507 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/data:fe8197 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$bc4507__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:bc4507 [app-ssr] (ecmascript) <text/javascript>"); // Assuming extendSession action exists
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$fe8197__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:fe8197 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function AppProvider({ children, user }) {
    ...
    const handleExtendSession = async ()=>{
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$fe8197__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["extendSession"])(); // Assuming this action exists and refreshes the session cookie
            if (result.success) {
    ...
    const handleLogout = async ()=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$bc4507__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["clearSession"])();
        router.push('/login');
        setIsModalOpen(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f44add17._.js.map